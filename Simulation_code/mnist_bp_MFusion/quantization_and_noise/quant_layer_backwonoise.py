...
class conv2d_quant_noise_backwonoise(nn.Conv2d):
    def __init__(self,
        ...
        super(conv2d_quant_noise_backwonoise, self).__init__(
...
class linear_quant_noise_backwonoise(nn.Linear):
    def __init__(self,
        ...
        super(linear_quant_noise_backwonoise, self).__init__(
                         m.in_features,
                         m.out_features,
                         bias=True if m.bias is not None else False,
                         )
...
QuanModuleMappingBackWoNoise = {
    nn.Conv2d: conv2d_quant_noise_backwonoise,
    nn.Linear: linear_quant_noise_backwonoise
}
QuanModule = [
    conv2d_quant_noise_backwonoise,
    linear_quant_noise_backwonoise
]