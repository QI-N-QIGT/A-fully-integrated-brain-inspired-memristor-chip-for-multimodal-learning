...
from e100_irtool.core import make_op, make_layer, make_ir #noqa
...
class MakeIROp:
    ...
    def Conv(self,ir,model_parser,node_name):
        ...
        # 判断卷积前一层是否为split层，如果是，则需要在ref name中加上序号
        # 序号为 ref name 所在node 的输出排序
