...
class TestShapeInferer(TestCase):
    ...
    def test_concat(self):
        ...
        self.t('concat', (3, 2), (1, 2), (2, 2), axis=1, with_batch=False, channel_pos='last')
        self.t('concat', (3, 2), (1, 2), (2, 2), axis=-1, with_batch=False, channel_pos='last')
        self.t('concat', (3, 2), (1, 2), (2, 2), axis=-1, channel_pos='last')
        self.t('concat', (2, 3), (2, 1), (2, 2), axis=1, with_batch=False, channel_pos='ignore')
    ...
    def test_conv_transpose(self):
        ...
        self.t('conv_transpose2d', (2, 4, 5), dilation=2, output_padding=1, **kwargs)
