...
class TestToJsonObj(TestCase):
    ...
    def test_scala(self):
        ...
        self.assertEqual(to_json_obj(b'\x00\x01\x02'), b'\x00\x01\x02')

    def test_array(self):
        d1 = [None, 1, 1.5, True, False, 'foo', b'\x00\x01\x02']
    ...
    def test_object(self):
        d1 = dict(a=[1, '2', False], b=1, c=1.5, d=True, e='foo', f=b'\x00\x01\x02')
        self.assertEqual(to_json_obj(d1), d1)
    ...
    def test_from_json_obj(self):
        ...
        self.assertEqual(Foo.from_json_obj([0.5, None]).__dict__, {'a': [0.5, None], 'k': {}})
        self.assertEqual(Foo.from_json_obj({'x': [True, {'y': []}]}).__dict__, {'a': [], 'k': {'x': [True, {'y': []}]}})
    ...
    def test_clone(self):
        ...
        class Foo(Jsonable):
            pass
        d = {'a': 1, 'b': False, 'c': [0.5, None, {'x': ['h', 'y']}]}
...
class TestLoadDumpJson(TestCase):
    ...
    def test_load_yaml(self):
        ...
        o = load_json(s)
        self.assertEqual(o, {'nm': 'foo', 'vs': [{'n': 'b1', 'v': True}, {'n': 'b2', 'v': None}, {'n': 3, 'v': [1, 2, {'a': 1, 'b': False, 'c': 'cc'}]}]})
    ...
    def test_load_json(self):
        ...
        self.assertEqual(o, [1, None, False, {'0': 0.5, 'b': {'x': 1, 'y': [2, True]}}])
