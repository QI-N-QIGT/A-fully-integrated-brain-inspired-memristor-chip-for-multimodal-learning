...
from ..core.type_util import is_integer, is_integers, to_int_tuple, is_boolean, is_number, to_var_token, is_one_of
...
class ConcatOp(ShapeOp):
    ...
    def __init__(self, *, axis=None, channel_pos=None, **kwargs):
        ...
        self.set_attr('channel_pos', to_var_token(channel_pos, none_ok=True), is_one_of, values=self.CHANNEL_POS)
...
class ReshapeOp(ShapeOp, UnaryOp):
    ...
    def __init__(self, *, shape=None, **kwargs):
        super().__init__(**kwargs)
        self.set_attr('shape', to_int_tuple(shape), is_integers, min_val=-1, not_none=True)
...
class TransposeOp(ShapeOp, UnaryOp):
    ...
    def __init__(self, *, perm=None, **kwargs):
        super().__init__(**kwargs)
        self.set_attr('perm', to_int_tuple(perm), is_integers, min_val=0, min_dim=2, not_none=True)
...
class PadOp(UnaryOp):
    ...
    def __init__(self, *, pads=None, value=None, **kwargs):
        super().__init__(**kwargs)
        self.set_attr('pads', to_int_tuple(pads), is_integers, min_val=0, min_dim=2)
