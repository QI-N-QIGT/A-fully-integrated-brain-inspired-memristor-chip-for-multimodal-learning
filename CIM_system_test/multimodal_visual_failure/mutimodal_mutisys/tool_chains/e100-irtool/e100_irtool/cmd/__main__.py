...
def main():
    import_modules(os.environ.get('E100_MODULES'))
    argp = ArgumentParser('python -m e100_irtool.cmd')
    argp.add_argument('-D', '--debug', action='store_true', help='dump exception')
    argp.add_argument('-M', '--modules', help='":" seperated module names, env E100_MODULES')
    ...
    if args.cmd_cls is None:
        argp.print_help()
        sys.exit(1)
    if to_boolean(os.environ.get('E100_DEBUG')):
        args.debug = True
