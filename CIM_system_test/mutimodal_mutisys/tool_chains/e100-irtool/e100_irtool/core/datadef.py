...
class DataDef(Jsonable):
    ...
    def __init__(self, ref=None, *, batch=None, channel=None, dims=None, dtype=None, channel_last=None, width=None, height=None, depth=None, ndim=None, shape=None, **kwargs):
        ...
        self.set_attr('dims', to_int_tuple(dims, keep_scalar=True), is_integers, min_val=1, min_dim=1)
        ...
        self.set_attr('shape', to_int_tuple(shape, keep_scalar=True), is_integers, min_val=0, min_dim=0)
    ...
    def make_shape(self, dims=None, channel_last=None):
        ...
        assert self.ndim is None or len(dims) == self.ndim, f'rank of dims {dims} != ndim {self.ndim}'
