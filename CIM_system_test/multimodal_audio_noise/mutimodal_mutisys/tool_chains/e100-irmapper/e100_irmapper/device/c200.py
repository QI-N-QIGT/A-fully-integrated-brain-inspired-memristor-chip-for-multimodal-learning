...
class C200MappingInfo(Jsonable):
    ...
    def __init__(self, *, col_split_num=1, row_split_num=1, col_repeat_num=1, row_repeat_num=1, para_same_array=1, para_diff_array=1, mappings=None, runtime='simulation', **kwargs):
...
class C200CalcInfo(Jsonable):
    ...
    def __init__(self, *, weight_scale=1, assigned_output_quant_scale=1, output_quant_mode=1, it_time=1, reg_shift_mode=0, output_half_level=0, shift_expansion_mode='bit_shift', noise_scale=noise_scale, adc_clamp=False, adc_quant=False, ADC_LUT=False, fit_k=1, fit_b=0, **kwargs):
