...
if __name__ == '__main__':
    device = [{'name': 'a111-0', 'kind': 'a111-npu', 'num': 1}]
    ...
    map1 = mapper(ir=onnx_ir, device=device, weight_format='HWC', place_strategy=A111Placement, masked_device_id_list=['Tile:1-XB:2'], target_device='a111')
    map1.run()
    mapped_ir = map1.ir
