...
ub_1 = [8] * 40
place = GeneticAlgorithm(parser.node_info, parser.node_weight, parser.hardware_config, ub=ub_1, lb=[1] * 40, precision=[1] * 40, size_pop=100, max_iter=100, place_strategy=OneOnOne, window_copy=True)
