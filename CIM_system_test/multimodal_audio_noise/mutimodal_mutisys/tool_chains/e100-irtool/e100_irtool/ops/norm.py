...
class BatchNormOp(UnaryOp):
    ...
    def __init__(self, *, channel=None, epsilon=None, scale=None, bias=None, input_mean=None, input_var=None, **kwargs):
        super().__init__(**kwargs)
        self.set_attr('channel', channel, is_integer, min_val=1)
        self.set_attr('epsilon', epsilon, is_number, lower_limit=0, upper_limit=1.0)
...
class InstanceNormOp(UnaryOp):
    ...
    def __init__(self, *, channel=None, epsilon=None, scale=None, bias=None, **kwargs):
        super().__init__(**kwargs)
        self.set_attr('channel', channel, is_integer, min_val=1)
