...
class ConvertONNX(object):
    ...
    def __init__(self, onnx_file=None, ir_file=None, weight_half_level=None, weight_scale=None, fix_layer_name=False, data_range_specify=None, data_clamp_std=0, store_intermediate_model=False, specify_input_layer=None, specify_output_layer=None):
    ...
    def _convert(self):
        ...
        self.model_parser = OnnxParser(model, self.weight_half_level, self.weight_scale, self.data_clamp_std, self.data_range_specify)
        self.ir = make_ir()
